package com.ymsw.generator.controller;
...
import com.ymsw.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"ymsw.zip\"");
