package com.ymsw.framework.shiro.web.session;

import com.ymsw.common.utils.Threads;
...
public class SpringSessionValidationScheduler implements SessionValidationScheduler
{
    ...
    public void enableSessionValidation()
    {
        ...
        {
            log.debug("Scheduling session validation templates.monitor.job using Spring Scheduler with "
        ...
        try
        {
            ...
            if (log.isDebugEnabled())
            {
                log.debug("Session validation templates.monitor.job successfully scheduled with Spring Scheduler.");
            }
        ...
        catch (Exception e)
        {
            ...
            {
                log.error("Error starting the Spring Scheduler session validation templates.monitor.job.  Session validation may not occur.", e);
            }
        }
    }
    ...
    public void disableSessionValidation()
    {
        if (log.isDebugEnabled())
        {
            log.debug("Stopping Spring Scheduler session validation templates.monitor.job...");
        }
